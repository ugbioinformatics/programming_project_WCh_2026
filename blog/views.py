...
def run_hess(tmpdir):
    """Uruchamia xtb xtbopt.xyz --hess, parsuje g98.out i generuje pliki mol2 dla każdej mody."""
    import numpy as np
    import math
    ...
    os.makedirs(f"{tmpdir}/vibrations")
    mol2_files = []
    for i, mode in enumerate(modes):
        vib_mol2 = f"{tmpdir}/vibrations/vib_{i}.mol2"
